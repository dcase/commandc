...
var accordion = Class.create({
    ...
    this.showAccordion.previous(0).removeClassName(this.options.classNames.toggleActive);
		...
		new Effect.BlindUp(this.showAccordion, 0, options);
	},
  ...
  //
	_handleAccordion : function() {
		...
		this.effects.push(new Effect.BlindDown(this.currentAccordion, 100, options));
		...
		if (this.showAccordion) {
			...
			this.effects.push(new Effect.BlindDown(this.showAccordion, 100, options));				
		}
